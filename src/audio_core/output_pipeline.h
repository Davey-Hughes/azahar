...
/// target at a bounded tempo, and Handover flushes it into the stash, where PeriodSplicer::
/// JoinFlush() closes the seam at the flush's end and trims the excess with it.
